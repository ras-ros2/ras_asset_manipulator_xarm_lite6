...
def generate_launch_description():
    ...
    # xarm_moveit_config_sim/launch/_dual_robot_moveit_realmove.launch.py
    robot_moveit_realmove_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('xarm_moveit_config_sim'), 'launch', '_dual_robot_moveit_realmove.launch.py'])),
        launch_arguments={
